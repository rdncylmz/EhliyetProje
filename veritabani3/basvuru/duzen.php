...
try{
 ...
 if($_POST){
  ...
  if($basvuruid!="" && $basvuruad!=""){
    $sonuc = $conn->exec("UPDATE basvuru SET  basvuru_ad ='$basvuruad' ,  basvuru_fiyat ='$fiyat'  WHERE basvuru_id='$basvuruid'");
  }else{
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Basvuru Düzenle</h1>
                    </div>
...
<div class="table-responsive">
  ...
  <tr ><th style='text-align:center;'>Basvuru Ad</th>
...
try{
 ...
 while ($row = $query->fetch()) {
  ...
  echo "<td style='text-align:center;'>".$row['basvuru_fiyat']."</td>";
    echo "<td style='text-align:center;'> <button class='basvuruduzen' id=".$row['basvuru_id'].">Düzenle</button>";
}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Basvuru duzenle</h5>
