...
try{
 ...
 if($basvuru!="" ){
$query=$conn->exec("insert into basvuru (basvuru_ad,basvuru_fiyat) VALUES('$basvuru','$basvuru3')");
if($query)
            ...
            <i class="fa fa-bars"></i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Basvuru Ekle</h1>
                    </div>
...
?>
  <form action="ekle.php" method="post">
    ...
    <label for="fname">Basvuru Ad</label>
    <input type="text" id="ad" name="ad"  placeholder="ad">
    <label for="fname">Basvuru Fiyatı</label>
